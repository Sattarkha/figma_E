...
export default function Footer(){
    return (
        <main>
            <div >
                <Image src={"/Frame 702.png"} width={800} height={140} alt="pta" className="pt-[400px] ml-72"/>
            </div>
        <div>
              <footer className="w-[1350px] h-[440px] top-[1191px] text-white bg-black mt-[200px] ">
                    <div className="w-[1170px] h-[236px] top-[80px] left-[135px] gap-[87px] flex">
                        ...
                        <Image className="pt-[14px] pl-[9px] mt-[20px] w-[80px] h-[80px] " src={"/Qrcode 1.png"} alt="" width={34} height={22} />
